        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-card border border-border rounded-lg p-8 mb-8">
            ...
            <p className="text-muted-foreground mb-6">
              We're currently updating our property listings for Eastleigh {section}. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                onClick={() => window.open('https://wa.me/254116733496?text=I%27m%20interested%20in%20properties%20in%20Eastleigh%20' + section, '_blank')}
              >
...
export default EastleighSection;
